...
(function (aufgabe2_2) {
    ...
    // c)
    class Studi {
        constructor(vorname, nachname, matrikelnr, studiengang) {
    ...
    // e)
    function generateRects(menge) {
        let array = [];
        for (let zähler = 0; zähler < menge; zähler++) {
            array.push(new Rechteck);
        }
        for (let stelle = 0; stelle < array.length; stelle++) {
